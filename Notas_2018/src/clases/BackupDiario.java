    ...
    public static void GenerarBackupDiarioMySQL() {
        ...
        if (existe == false) {
            try {
                ...
                Process child = runtime.exec("C:\\Archivos de programa\\MySQL\\MySQL Server 5.6\\bin\\mysqldump -u " + Conexion.user + " -p" + Conexion.passw + " --default-character_set=utf8 " + Conexion.dbname);
