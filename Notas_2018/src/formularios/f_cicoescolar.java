 ...
 * @author GLARA
 */
public class f_cicoescolar extends javax.swing.JInternalFrame {

    /**
     * Variables para realizar las transacciones con la base de datos
     */
    String nombreTabla = "cicloescolar";
    String[] titulos = {"Id", "Descripción", "Fecha Ini", "Fecha Fin", "Estado"};
    String campos = "descripcion, fechainicio, fechacierre, estado";
    String nombreId = "idañoescolar";
    ...
    /**
     * Prepara el formulario y jtable para crear un nuevo categoria (Habilita y
    ...
    private String getFecha1() {
        ...
        try {
            String fecha;
            int años = dateFecha1.getCalendar().get(Calendar.YEAR);
            int dias = dateFecha1.getCalendar().get(Calendar.DAY_OF_MONTH);
            int mess = dateFecha1.getCalendar().get(Calendar.MONTH) + 1;
            int hours = dateFecha1.getCalendar().get(Calendar.HOUR_OF_DAY);
            int minutes = dateFecha1.getCalendar().get(Calendar.MINUTE);
            int seconds = dateFecha1.getCalendar().get(Calendar.SECOND);
    ...
    /* Funcion para llenar la tabla cuando se busque un categoria en especifico
    ...
    public void llenarTabla(String nombre) {
        ...
        try {
            ...
            /* Llamamos a la funcion consultaCategoria la cual nos devuelve todos 
             las categorias relaciones con el valor a buscar en la base de datos. 
            
             - Los datos recibidos lo guardamos en el objeto ResulSet para luego
             llenar la tabla con los registros.
            
             */
            ResultSet rs = peticiones.consultaCicloescolar(nombre);
            ...
            while (rs.next()) {
                ...
                registro[0] = rs.getString("idañoescolar");
                registro[1] = rs.getString("descripcion");
                //registro[2] = rs.getString("nombre");
                registro[2] = rs.getDate("fechainicio");
                registro[3] = rs.getDate("fechacierre");
    ...
    public void llenarFormulario(int s) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                dateFecha.setDate(rs.getDate("fechainicio"));
                dateFecha1.setDate(rs.getDate("fechacierre"));
    ...
    /**
     * Realiza la transacción para guardar los recistros de un nuevo categoria
     */
    private void Guardar() {
        ...
        Object[] categoria = {
            txtDescripcion.getText(), getFecha(),getFecha1(), peticiones.selected(rbEstado)
        };

        /* Llamamos a la funcion guardarRegistros la cual recibe como parametro
         el nombre de la tabla, los campos y los valores a insertar del categoria */
        if (peticiones.guardarRegistros(nombreTabla, campos, categoria)) {
    ...
    private void Modificar() {
        ...
        Object[] categoria = {
            txtDescripcion.getText(), getFecha(), getFecha1(),peticiones.selected(rbEstado), id
        };

        if (peticiones.actualizarRegistroId(nombreTabla, campos, categoria, nombreId)) {
    ...
    private void initComponents() {
        ...
        labelBusqueda.setText("Buscar Categoría");
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            txtDescripcion.setBounds(170, 80, 250, 25);
            ...
            panelFormulario.add(labelFecha1);
            labelFecha1.setBounds(350, 120, 120, 25);

            dateFecha1.setDate(Calendar.getInstance().getTime());
            dateFecha1.setDateFormatString("dd/MM/yyyy");
            dateFecha1.setEnabled(false);
            dateFecha1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
            dateFecha1.setIcon(null);
            dateFecha1.setMaxSelectableDate(new java.util.Date(3093496470100000L));
            dateFecha1.setMinSelectableDate(new java.util.Date(-62135744300000L));
            dateFecha1.setPreferredSize(new java.awt.Dimension(120, 22));
            panelFormulario.add(dateFecha1);
            dateFecha1.setBounds(490, 120, 130, 25);
            ...
            labelEncabezado.setText("CATEGORÍA");
