...
public class unidad extends javax.swing.JInternalFrame {
     ...
     */
    String nombreTabla = "unidad";
    String[] titulos = {"Id", "Código", "Descripción Unidad", "Fecha Reg", "Estado"};
    String campos = "codigo, nombre, fec_reg, estado";
    String nombreId = "idUnidad";
    ...
    /**
     * Prepara el formulario y jtable para crear un nuevo unidad (Habilita y
    ...
    /* Funcion para llenar la tabla cuando se busque un unidad en especifico
    ...
    public void llenarTabla(String nombre) {
        ...
        try {
            ...
            /* Llamamos a la funcion consultaUnidad la cual nos devuelve todos 
             las unidades relaciones con el valor a buscar en la base de datos. 
            
             - Los datos recibidos lo guardamos en el objeto ResulSet para luego
             llenar la tabla con los registros.
            
             */
            ResultSet rs = peticiones.consultaUnidad(nombre);
            ...
            while (rs.next()) {
                ...
                registro[0] = rs.getString("idUnidad");
    ...
    /**
     * Realiza la transacción para guardar los recistros de un nuevo unidad
     */
    private void Guardar() {
        ...
        /* Llamamos a la funcion guardarRegistros la cual recibe como parametro
         el nombre de la tabla, los campos y los valores a insertar del unidad */
        if (peticiones.guardarRegistros(nombreTabla, campos, unidad)) {
    ...
    private void Modificar() {
        ...
        if (peticiones.actualizarRegistroId(nombreTabla, campos, unidad, nombreId)) {
    ...
    private void initComponents() {
        ...
        labelBusqueda.setText("Buscar Unidad");
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            labelEncabezado.setText("UNIDAD");
