 ...
 * @author GLARA
 */
public class f_docente extends javax.swing.JInternalFrame {

    /**
     * Variables para realizar las transacciones con la base de datos
     */
    String nombreTabla = "Docente";
    String[] titulos = {"Id", "Nombres", "Apellidos", "Fecha", "Estado"};
    String campos = "codigo,identificacion, nombre, apellido, direccion, telefono, fechainicio, estado";
    String nombreId = "iddocente";
...
//    }
    ...
    private void llenarTabla(String nombre) {
        ...
        try {
             ...
             */
            ResultSet rs = peticiones.consultaDocente(nombre);
            Object[] registro = new Object[8];//numero de campos 1 mas siempre
            ...
            while (rs.next()) {
                ...
                registro[6] = rs.getString("fechainicio");
...
//        }
        ...
        Object[] producto = {
            ...
            txtCodigo.getText(), txtidentificacion.getText(), txtNombres.getText(), txtApellidos.getText(),txtDireccion.getText(),
            txtTelefono.getText(), getFecha(), peticiones.selected(rbEstado)
...
//        }
        ...
        Object[] producto = {
           txtCodigo.getText(), txtidentificacion.getText(), txtNombres.getText(), txtApellidos.getText(),txtDireccion.getText(),
            txtTelefono.getText(), getFecha(), peticiones.selected(rbEstado), id
        };
    ...
    private void initComponents() {
        ...
        txtidentificacion = new elaprendiz.gui.textField.TextField();
        labelCorreo4 = new javax.swing.JLabel();

        setBackground(new java.awt.Color(255, 255, 255));
        setName("docente"); // NOI18N
        setOpaque(true);
        ...
        labelBusqueda.setText("Buscar Docente");
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            labelEncabezado.setText("DOCENTE");
            ...
            panelFormulario.add(labelFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 80, 120, 25));
            ...
            panelFormulario.add(txtNombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, 320, 25));
            ...
            panelFormulario.add(dateFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 80, 130, 25));
            ...
            panelFormulario.add(labelCodigo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, 120, 25));
            ...
            panelFormulario.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 130, 25));
            ...
            txtidentificacion.setOpaque(true);
            txtidentificacion.setPreferredSize(new java.awt.Dimension(120, 21));
            panelFormulario.add(txtidentificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 320, 25));
            ...
            labelCorreo4.setText("Identificación*");
            labelCorreo4.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
            panelFormulario.add(labelCorreo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 120, 25));
    ...
    private elaprendiz.gui.textField.TextField txtidentificacion;
