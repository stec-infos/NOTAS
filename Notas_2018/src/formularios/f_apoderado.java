 ...
 * @author GLARA
 */
public class f_apoderado extends javax.swing.JInternalFrame {

    /**
     * Variables para realizar las transacciones con la base de datos
     */
    String nombreTabla = "apoderado";
    String[] titulos = {"Id", "Nombres", "Apellidos", "Identificación", "Dirección", "Sexo", "Ocupación","Télefono"};
    String campos = "nombres,apellidos, dpi, direccion, sexo, ocupacion, telefono";
    String nombreId = "idapoderado";
...
//    }
    ...
    public void llenarTabla(String nombre) {
        ...
        try {
             ...
             */
            ResultSet rs = peticiones.consultaApoderado(nombre);
            ...
            while (rs.next()) {
                ...
                registro[0] = rs.getString("idapoderado");
                registro[1] = rs.getString("nombres");
                registro[2] = rs.getString("apellidos");
                registro[3] = rs.getString("dpi");
    ...
    private void Guardar() {
        ...
        Object[] cliente = {
            txtNombres.getText(), txtApellidos.getText(), txtDpi.getText(),
            txtDireccion.getText(),txtSexo.getText(), txtOcupacion.getText(), 
            txtTelefono.getText()
        };
    ...
    private void initComponents() {
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            labelNit.setText("Identifiación");
            ...
            txtDpi.setDisabledTextColor(new java.awt.Color(0, 0, 0));
            txtDpi.setEnabled(false);
            txtDpi.setOpaque(true);
            txtDpi.setPreferredSize(new java.awt.Dimension(120, 21));
            panelFormulario.add(txtDpi);
            txtDpi.setBounds(170, 120, 250, 25);
            ...
            labelEncabezado.setText("APODERADO");
    ...
    private elaprendiz.gui.textField.TextField txtDpi;
