...
public class proveedor extends javax.swing.JInternalFrame {
    ...
    String[] titulos = {"Id", "Código", "Nombre Proveedor", "Dirección", "Nit", "Teléfono"};
    String campos = "codigo, nombre, direccion, correo, nit, telefono, fec_reg, contacto, estado";
    String nombreId = "idProveedor";
    ...
    /**
     * Prepara el formulario y jtable para crear un nuevo proveedor (Habilita y
    ...
    /* Funcion para llenar la tabla cuando se busque un proveedor en especifico
    ...
    public void llenarTabla(String nombre) {
        ...
        try {
            ...
            /* Llamamos a la funcion consultaProveedores la cual nos devuelve todos 
             los proveedores relaciones con el valor a buscar en la base de datos. 
            
             - Los datos recibidos lo guardamos en el objeto ResulSet para luego
             llenar la tabla con los registros.
            
             */
            ResultSet rs = peticiones.consultaProveedores(nombre);
    ...
    /**
     * Realiza la transacción para guardar los recistros de un nuevo proveedor
     */
    private void Guardar() {
        ...
        Object[] proveedor = {
            ...
            txtTelefono.getText(), getFecha(), txtContacto.getText(),
            peticiones.selected(rbEstado)
        };

        /* Llamamos a la funcion guardarRegistros la cual recibe como parametro
         el nombre de la tabla, los campos y los valores a insertar del proveedor */
        if (peticiones.guardarRegistros(nombreTabla, campos, proveedor)) {
    ...
    private void Modificar() {
        ...
        if (peticiones.actualizarRegistroId(nombreTabla, campos, proveedor, nombreId)) {
    ...
    private void initComponents() {
        ...
        labelBusqueda.setText("Buscar Proveedor");
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            txtContacto.setPreferredSize(new java.awt.Dimension(120, 21));
            panelFormulario.add(txtContacto);
            txtContacto.setBounds(610, 80, 250, 25);
            ...
            labelEncabezado.setText("PROVEEDORES");
