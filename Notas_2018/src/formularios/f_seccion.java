...
public class f_seccion extends javax.swing.JInternalFrame {
    ...
    /**
     * Prepara el formulario y jtable para crear un nuevo seccion (Habilita y
...
//    }
    ...
    /* Funcion para llenar la tabla cuando se busque un seccion en especifico
    ...
    public void llenarTabla(String nombre) {
        ...
        try {
             ...
             */
            ResultSet rs = peticiones.consultaSeccion(nombre);
            ...
            while (rs.next()) {
                ...
                registro[0] = rs.getString("idseccion");
...
//                }
    ...
    /**
     * Realiza la transacción para guardar los recistros de un nuevo seccion
     */
    private void Guardar() {
        ...
        /* Llamamos a la funcion guardarRegistros la cual recibe como parametro
         el nombre de la tabla, los campos y los valores a insertar del seccion */
        if (peticiones.guardarRegistros(nombreTabla, campos, seccion)) {
    ...
    private void initComponents() {
        ...
        labelBusqueda.setText("Buscar Sección");
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            labelNombre.setBounds(30, 110, 120, 25);
            ...
            txtnombre.setBounds(170, 110, 250, 25);
            ...
            labelEncabezado.setText("SECCIÓN");
