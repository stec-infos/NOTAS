...
public class Backup extends javax.swing.JInternalFrame {
    ...
    void GenerarBackupMySQL() {
        ...
        if (resp == JFileChooser.APPROVE_OPTION) {//Si el usuario presiona aceptar; se genera el Backup
            try {
                ...
                Process child = runtime.exec("C:\\xampp\\mysql\\bin\\mysqldump -u " + Conexion.user + " -p" + Conexion.passw + " --default-character_set=utf8 " + Conexion.dbname);
    ...
    private void buttonAction1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAction1ActionPerformed
        ...
        if (AccesoUsuario.AccesosUsuario(buttonAction1.getName()) == false) {
            GenerarBackupMySQL();
        } else {
