...
//    }
    ...
    public void llenarTabla(String nombre) {
        ...
        try {
             ...
             */
            ResultSet rs = peticiones.consultaNivel(nombre);
            ...
            while (rs.next()) {
                ...
                registro[0] = rs.getString("idnivel");
    ...
    private void Guardar() {
        ...
        Object[] categoria = {
            txtDescripcion.getText(), peticiones.selected(rbEstado)
        };
    ...
    private void Modificar() {
        ...
        Object[] categoria = {
            txtDescripcion.getText(), peticiones.selected(rbEstado), id
        };
    ...
    private void initComponents() {
        ...
        labelBusqueda.setText("Buscar Nivel Escolar");
        ...
        tableResultados.setModel(model = new DefaultTableModel(null, titulos)
            ...
            labelEncabezado.setText("NIVEL ESCOLAR");
